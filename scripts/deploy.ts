...
async function main() {
  ...
  if (network.name === "mainnet") {
    create2Factory = "0x17383736805faC95E075f77CFfDA41BAEBB55533"; //create2 for mumbai and goerli
    WETHContractAddress = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2";
  } else if (network.name === "goerli" || network.name === "mumbai") {
    EOA = await ethers.getSigner("0x00000000000d3b4EA88f9B3fE809D386B86F5898");
    create2Factory = "0x17383736805faC95E075f77CFfDA41BAEBB55533";
