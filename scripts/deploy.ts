...
async function main() {
    ...
    if (network.name === "mainnet") {
      ...
      EOA = await ethers.getSigner(
        "0x0FCf4D3EA80FA5281A2Ee4105b543F70a4D1Ce35"
      );
      create2Factory = "0x4A64208814b14E5CA2475349ebC38B40CE2e1373";
      WETHContractAddress = "0x82080454665F50c83DC43bd2A0daB4cAC62727f5";
      ...
      await weth9.deposit({ value: ethers.utils.parseEther("50") });
    }
    if (!create2Factory) {
    ...
    const walletOwnerPrivateKey = '0x3a77989543d0f0a85e2cc6a62dc3c9c703f15daf69c94de27edf7ea7f18a4e01';
