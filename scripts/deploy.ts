...
async function main() {
  ...
  if (network.name === "mainnet") {
    ...
    EOA = await ethers.getSigner("0x35729f9F57EbA0e25996Aa58A77e2287AB08FD48");
    create2Factory = "0xE1Dd62164bD98Ea33e67B08eD875848b6e130B25";
    WETHContractAddress = "0x4033c027a184D824d3129de1f02FBc42eD58be32";
  ...
  if (_b.lt(ethers.utils.parseEther("0.02"))) {
    console.log("sending 0.000001 WETH to wallet");
